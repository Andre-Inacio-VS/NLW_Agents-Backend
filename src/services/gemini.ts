...
export async function generateAnswer(
  ...
  const prompt = `
    ...
    - Se a resposta não puder ser encontrada no contexto, apenas responda que não possui informações suficientes para responder;
    - Seja objetivo;
  ...
  if (!response.text) {
    throw new Error("Falha ao gerar resposta pelo Gemini A.I.");
  }
